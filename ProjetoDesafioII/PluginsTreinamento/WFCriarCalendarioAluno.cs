...
namespace PluginsTreinamento
{
    public class WFCriarCalendarioAluno : CodeActivity
    {
        ...
        protected override void Execute(CodeActivityContext executionContext)
        {
            ...
            Entity entityAlunoXCursoDisponivel = service.Retrieve("dio_alunosxcursos", guidAlunoXCurso,
                new ColumnSet("dio_curso", "dio_periodo", "dio_datadeinicio"));
            ...
            if (entityAlunoXCursoDisponivel != null)
            {
                ...
                guidCurso = ((EntityReference)entityAlunoXCursoDisponivel.Attributes["dio_curso"]).Id;
              ...
              {
                  Entity entityCurso = service.Retrieve("dio_cursos", guidCurso, new ColumnSet("dio_duracao"));
                   int horasDuracao = 0;
                  ...
                  if (diasNecessarios > 0)
                  {
                      for (int i = 0; i < diasNecessarios; i++)
                      {
                          ...
                          entCalendarioAluno["dio_alunosxcursos"] = new EntityReference("dio_alunosxcursos", guidAlunoXCurso);
